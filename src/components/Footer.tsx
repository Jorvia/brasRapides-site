export default function Footer() {
  return (
    <footer className="bg-[#1E355E] text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Votre partenaire de confiance pour tous vos déménagements en
              France. Service professionnel, rapide et fiable depuis plus de 10
              ans.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="bg-[#5073C0] rounded-xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="#contact"
                className="bg-[#B54340] hover:bg-[#A03A37] text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors"
              >
                Nous contacter
              </a>
            </div>
